...
import "../Helper/Helperr.js" as Helper
import "../indicators"
Rectangle {
    //root map init
    id: mapview
...
/**************************************/
    ...
    Map {
            ...
            Connections{
                property int k:0
                   ...
                   onNewPositions:{
                       k+=1
                       if(k>1){
                       var cor =QtPositioning.coordinate(latitude,longitude)

                       planeMarker.coordinate =cor
                       lifly.addCoordinate(cor)
                       }
                    }
                   onYawchange:{
                       rotateImage.angle = yaww.toFixed(0)
        ...
        MouseArea{
            ...
            property double p_lati:0
            property double p_longi:0
            property double distance:0
            acceptedButtons: Qt.LeftButton | Qt.RightButton
            property int statess: 0
                ...
                if(statess==1){
                    if(mapmenu.visible){
                        ...
                        if(mouse.button & Qt.LeftButton) {
                            ...
                            md.append({"coords": coord,"title":count+1})
